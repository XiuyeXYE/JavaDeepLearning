...
//				log(keyCode);
	...
	private Stage createStage(String title, Image image) {
		...
		ImageProperty ip = new ImageProperty(title);
		iv.imageProperty().bind(ip);
	...
	private static class ImageProperty implements ObservableValue<Image>{

		private String title;

		public ImageProperty(String title){
			this.title = title;
		}
